...
import org.jboss.weld.spock.auto.beans.InjectedV8
...
class ScannedClassesAreNotForcedBeansTest extends Specification {
    ...
    def 'V8 should not be ambiguous for not being incorrectly identified as a bean class'(V8 engine) {
        expect:
            engine != null
    }
}
