...
import org.jboss.weld.spock.auto.beans.ConstructedV8
...
class ScannedParameterClassesAreNotForcedBeansTest extends Specification {
    ...
    def 'V8 should not be ambiguous for not being incorrectly identified as a bean class from parameter'(V8 engine) {
        expect:
            engine != null
    }
}
